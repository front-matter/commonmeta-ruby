...
describe Briard::Metadata, vcr: true do
  context "write metadata as crossref" do
    ...
    it "journal article from datacite" do
      ...
      expect(subject.type["schemaOrg"]).to eq("JournalArticle")
      ...
      expect(subject.license).to eq([{ "rights" => "VCH Verlagsgesellschaft mbH" }])
    end
    ...
    it "schema.org from another science blog" do
      ...
      expect(subject.creators).to eq([{ "familyName" => "Winston",
                                        "givenName" => "Donny",
                                        "nameIdentifiers" => [{ "nameIdentifier" => "https://orcid.org/0000-0002-8424-0604",
                                                                "nameIdentifierScheme" => "ORCID",
                                                                "schemeUri" => "https://orcid.org" }],
                                        "type" => "Person" }])
      ...
      expect(subject.date).to eq([{ "date" => "2022-10-21", "dateType" => "Issued" },
