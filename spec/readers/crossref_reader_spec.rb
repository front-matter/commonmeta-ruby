...
describe Briard::Metadata, vcr: true do
  ...
  context "get crossref metadata" do
    it "DOI with data citation" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/4374", "name" => "eLife Sciences Publications, Ltd")
    ...
    it "journal article" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/340", "name" => "Public Library of Science (PLoS)")
    ...
    it "journal article with funding" do
      ...
      expect(subject.creators.first).to eq("type" => "Person", "familyName" => "Fortes", "givenName" => "Ana Margarida")
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/1965", "name" => "Frontiers Media SA")
    ...
    it "journal article original language title" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/4426", "name" => "The Japanese Society of Physical Fitness and Sports Medicine")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "journal article with RDF for container" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/286", "name" => "Oxford University Press (OUP)")
    ...
    it "book chapter with RDF for container" do
      ...
      expect(subject.creators.first).to eq("familyName" => "Chen", "givenName" => "Lili", "type" => "Person")
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/297", "name" => "Springer Science and Business Media LLC")
    ...
    it "posted_content" do
      ...
      expect(subject.creators.last).to eq("id" => "https://orcid.org/0000-0003-4060-7360", "givenName" => "Timothy", "familyName" => "Clark", "type" => "Person")
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/246", "name" => "Cold Spring Harbor Laboratory")
    ...
    it "dissertation" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/5387", "name" => "University of Queensland Library")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "DOI with SICI DOI" do
      ...
      expect(subject.type).to eq("JournalArticle")
      expect(subject.creators).to eq([{ "familyName" => "Fenton", "givenName" => "A.", "type" => "Person" }, { "familyName" => "Rands", "givenName" => "S. A.", "type" => "Person" }])
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/311", "name" => "Wiley")
    ...
    it "DOI with ORCID ID" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/98", "name" => "Hindawi Limited")
      expect(subject.references.length).to eq(27)
      expect(subject.references.last).to eq("doi" => "https://doi.org/10.1378/chest.12-0045", "key" => "30")
    ...
    it "date in future" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/78", "name" => "Elsevier BV")
    ...
    it "vor with url" do
      ...
      expect(subject.creators.first).to eq("type" => "Person", "familyName" => "Gross", "givenName" => "J B")
    ...
    it "dataset" do
      ...
      expect(subject.creators.length).to eq(2)
      expect(subject.creators.first).to eq("type" => "Person", "givenName" => "G.", "familyName" => "Fermi")
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/7763", "name" => "Worldwide Protein Data Bank")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "dataset usda" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/1450", "name" => "USDA Forest Service")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "another book chapter" do
      ...
      expect(subject.type).to eq("BookChapter")
      expect(subject.creators).to eq([{ "familyName" => "Jones", "givenName" => "Hunter M.", "type" => "Person" }])
    ...
    it "yet another book chapter" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/2432", "name" => "IGI Global")
      expect(subject.provider).to eq("Crossref")
      expect(subject.container["type"]).to eq("Book")
    ...
    it "missing creator" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/1968", "name" => "MDPI AG")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "book" do
      ...
      expect(subject.creators).to eq([{ "type" => "Person", "familyName" => "Leung", "givenName" => "Vincent S." }])
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/56", "name" => "Cambridge University Press (CUP)")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "another book" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/1029", "name" => "International Ocean Discovery Program (IODP)")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "yet another book" do
      ...
      expect(subject.type).to eq("Book")
      expect(subject.creators).to eq([{ "type" => "Person", "familyName" => "McGinnis", "givenName" => "Richard Frank" }])
    ...
    it "mEDRA" do
      ...
      expect(subject.type).to eq("JournalArticle")
      expect(subject.creators.length).to eq(2)
      expect(subject.creators.first).to eq("type" => "Person", "familyName" => "Oh", "givenName" => "Sohae Eve")
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/4169", "name" => "Franco Angeli")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "KISTI" do
      ...
      expect(subject.type).to eq("JournalArticle")
      expect(subject.creators.length).to eq(7)
      expect(subject.creators.first).to eq("type" => "Person", "familyName" => "Huang", "givenName" => "Guimei")
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/2923", "name" => "Korean Chemical Society")
    ...
    it "JaLC" do
      ...
      expect(subject.type).to eq("JournalArticle")
      expect(subject.creators).to eq([{ "familyName" => "KUSUMOTO", "givenName" => "Hiroyuki", "type" => "Person" }])
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/272", "name" => "Japan Science and Technology Agency (JST)")
    ...
    it "OP" do
      ...
      expect(subject.creators.first).to eq("name" => "EFSA Panel on Food Additives and Nutrient Sources added to Food (ANS)", "type" => "Organization")
    ...
    it "multiple titles" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/2399", "name" => "OpenEdition")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "multiple titles with missing" do
      ...
      expect(subject.creators.first).to eq("familyName" => "Myers", "givenName" => "Chad L", "type" => "Person")
    ...
    it "markup" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/175", "name" => "The Royal Society")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "invalid date" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/194", "name" => "Georg Thieme Verlag KG")
    end
    ...
    it "affiliation is space" do
      ...
      expect(subject.creators.first).to eq("familyName" => "Petrovici", "givenName" => "Norbert", "type" => "Person")
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/179", "name" => "SAGE Publications")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "article id as page number" do
      ...
      expect(subject.type).to eq("JournalArticle")
      expect(subject.creators.length).to eq(5)
      expect(subject.creators.first).to eq("familyName" => "Marrazzo", "givenName" => "Antimo", "type" => "Person")
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/16", "name" => "American Physical Society (APS)")
    ...
    it "posted content copernicus" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/3145", "name" => "Copernicus GmbH")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "book oup" do
      ...
      expect(subject.creators.first).to eq("type" => "Person", "familyName" => "Clayton", "givenName" => "Barbra R.")
    ...
    it "report osti" do
      ...
      expect(subject.creators.first).to eq("type" => "Person", "familyName" => "Denholm", "givenName" => "P.")
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/960", "name" => "Office of Scientific and Technical Information (OSTI)")
      expect(subject.provider).to eq("Crossref")
    end
    ...
    it "journal issue" do
      ...
      expect(subject.publisher).to eq("id" => "https://api.crossref.org/members/4021", "name" => "Baskent University")
