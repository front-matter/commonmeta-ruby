...
describe Briard::Metadata, vcr: true do
  ...
  context "get crossref metadata" do
    ...
    it "journal article with funding" do
      ...
      expect(subject.creators.first).to eq("nameType" => "Personal", "familyName" => "Fortes", "givenName" => "Ana Margarida",
    ...
    it "book chapter with RDF for container" do
      ...
      expect(subject.related_identifiers.first).to eq(
        "relatedIdentifier" => "1611-3349", "relatedIdentifierType" => "ISSN", "relationType" => "IsPartOf", "resourceTypeGeneral" => "Collection",
      )
    ...
    it "posted_content" do
      ...
      expect(subject.creators.last).to eq("nameIdentifiers" => [{ "nameIdentifier" => "https://orcid.org/0000-0003-4060-7360", "nameIdentifierScheme" => "ORCID", "schemeUri" => "https://orcid.org" }], "name" => "Clark, Timothy", "givenName" => "Timothy", "familyName" => "Clark", "nameType" => "Personal")
    ...
    it "peer review" do
      ...
      expect(subject.creators.last).to eq("nameType" => "Personal", "affiliation" => [{ "name" => "Center for Computational Mathematics, Flatiron Institute, New York, United States" }],
                                          "familyName" => "Barnett",
                                          "givenName" => "Alex H",
                                          "name" => "Barnett, Alex H")
    ...
    it "DOI with SICI DOI" do
      ...
      expect(subject.types).to eq("bibtex" => "article", "citeproc" => "article-journal",
                                  "resourceType" => "JournalArticle", "resourceTypeGeneral" => "JournalArticle", "ris" => "JOUR", "schemaOrg" => "ScholarlyArticle")
      expect(subject.creators).to eq([{ "familyName" => "Fenton", "givenName" => "A.", "name" => "Fenton, A.", "nameType" => "Personal" }, { "familyName" => "Rands", "givenName" => "S. A.", "name" => "Rands, S. A.", "nameType" => "Personal" }])
    ...
    it "vor with url" do
      ...
      expect(subject.creators.first).to eq("nameType" => "Personal", "familyName" => "Gross", "givenName" => "J B", "name" => "Gross, J B")
    ...
    it "yet another book chapter" do
      ...
      expect(subject.types).to eq("bibtex" => "inbook", "citeproc" => "chapter",
                                  "resourceType" => "BookChapter", "resourceTypeGeneral" => "BookChapter", "ris" => "CHAP", "schemaOrg" => "Chapter")
      expect(subject.creators).to eq([{ "nameType" => "Personal", "affiliation" => [{ "name" => "Université de Lyon, France" }],
                                        "familyName" => "Bichot", "givenName" => "Charles-Edmond", "name" => "Bichot, Charles-Edmond" }])
    ...
    it "missing creator" do
      ...
      expect(subject.creators).to eq([{ "familyName" => "Kohls",
                                      ...
                                      { "familyName" => "Mele",
                                        "givenName" => "Salvatore",
                                        "name" => "Mele, Salvatore",
                                        "nameIdentifiers" => [{ "nameIdentifier" => "https://orcid.org/0000-0003-0762-2235",
                                                                "nameIdentifierScheme" => "ORCID",
                                                                "schemeUri" => "https://orcid.org" }],
                                        "nameType" => "Personal" }])
    ...
    it "book" do
      ...
      expect(subject.creators).to eq([{ "nameType" => "Personal", "familyName" => "Leung", "givenName" => "Vincent S.", "name" => "Leung, Vincent S." }])
    ...
    it "yet another book" do
      ...
      expect(subject.types).to eq("bibtex" => "book", "citeproc" => "book", "resourceType" => "Monograph",
                                  "resourceTypeGeneral" => "Book", "ris" => "BOOK", "schemaOrg" => "Book")
      expect(subject.creators).to eq([{ "nameType" => "Personal", "familyName" => "McGinnis", "givenName" => "Richard Frank", "name" => "McGinnis, Richard Frank" }])
      ...
      expect(subject.agency).to eq("Crossref")
      expect(subject.date_registered).to eq("2011-09-08")
    end
    ...
    it "mEDRA" do
      ...
      expect(subject.types).to eq("bibtex" => "article", "citeproc" => "article-journal",
                                  "resourceType" => "JournalArticle", "resourceTypeGeneral" => "JournalArticle", "ris" => "JOUR", "schemaOrg" => "ScholarlyArticle")
      expect(subject.creators.length).to eq(2)
      expect(subject.creators.first).to eq("nameType" => "Personal", "familyName" => "Oh", "givenName" => "Sohae Eve",
                                           "name" => "Oh, Sohae Eve")
    ...
    it "KISTI" do
      ...
      expect(subject.types).to eq("bibtex" => "article", "citeproc" => "article-journal",
                                  "resourceType" => "JournalArticle", "resourceTypeGeneral" => "JournalArticle", "ris" => "JOUR", "schemaOrg" => "ScholarlyArticle")
      expect(subject.creators.length).to eq(7)
      expect(subject.creators.first).to eq("nameType" => "Personal", "familyName" => "Huang", "givenName" => "Guimei", "name" => "Huang, Guimei")
    ...
    it "multiple titles with missing" do
      ...
      expect(subject.creators.first).to eq("familyName" => "Myers", "givenName" => "Chad L", "name" => "Myers, Chad L", "nameType" => "Personal")
    ...
    it "empty given name" do
      ...
      expect(subject.types).to eq("bibtex" => "article", "citeproc" => "article-journal",
                                  "resourceType" => "JournalArticle", "resourceTypeGeneral" => "JournalArticle", "ris" => "JOUR", "schemaOrg" => "ScholarlyArticle")
      expect(subject.creators.length).to eq(5)
      expect(subject.creators[3]).to eq("nameType" => "Personal", "familyName" => "Ehtisham-ul-Haq",
    ...
    it "journal article with" do
      ...
      expect(subject.rights_list).to eq([
                                          { "rightsUri" => "http://doi.wiley.com/10.1002/tdm_license_1.1" },
                                        ])
      ...
      expect(subject.agency).to eq("Crossref")
      expect(subject.date_registered).to eq("2017-06-05")
    end
    ...
    it "multiple issn" do
      ...
      expect(subject.agency).to eq("Crossref")
      expect(subject.date_registered).to eq("2012-10-31")
    end
    ...
    it "article id as page number" do
      ...
      expect(subject.agency).to eq("Crossref")
      expect(subject.date_registered).to eq("2018-03-13")
    end
    ...
    it "book oup" do
      ...
      expect(subject.creators.first).to eq("nameType" => "Personal", "familyName" => "Clayton", "givenName" => "Barbra R.",
                                           "name" => "Clayton, Barbra R.")
    ...
    it "report osti" do
      ...
      expect(subject.creators.first).to eq("nameType" => "Personal", "familyName" => "Denholm", "givenName" => "P.", "name" => "Denholm, P.")
