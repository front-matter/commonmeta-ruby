...
describe Commonmeta::Metadata, vcr: true do
  ...
  context "get schema_org metadata" do
    ...
    it "zenodo" do
      ...
      expect(subject.creators.first).to eq("type" => "Person", "givenName" => "Matthias", "familyName" => "Staib", "id" => "https://orcid.org/0000-0001-9688-838X", "affiliation" => [{ "name" => "University of Zurich, Zurich, Switzerland" }])
  ...
  context "get schema_org metadata as string" do
    ...
    it "TOPMed dataset" do
      ...
      expect(subject.references).to eq([{ "doi" => "10.23725/2g4s-qv04", "key" => "https://doi.org/10.23725/2g4s-qv04" }])
