...
describe Briard::Metadata, vcr: true do
  ...
  context 'get crossref_json metadata' do
    ...
    it 'DOI with SICI DOI' do
      ...
      expect(subject.creators).to eq([
                                       { 'name' => 'Fenton, A.', 'givenName' => 'A.',
                                         'familyName' => 'Fenton' }, { 'name' => 'Rands, S. A.', 'givenName' => 'S. A.', 'familyName' => 'Rands' }
                                     ])
    ...
    it 'date in future' do
      ...
      expect(subject.creators.first).to eq('name' => 'Beck, Sarah E.',
    ...
    it 'dataset' do
      ...
      expect(subject.creators.length).to eq(2)
      expect(subject.creators.first).to eq('name' => 'Fermi, G.', 'givenName' => 'G.', 'familyName' => 'Fermi')
    ...
    it 'book chapter' do
      ...
      expect(subject.types).to eq('bibtex' => 'inbook', 'citeproc' => 'chapter',
                                  'resourceType' => 'BookChapter', 'resourceTypeGeneral' => 'BookChapter', 'ris' => 'CHAP', 'schemaOrg' => 'Chapter')
      expect(subject.creators.length).to eq(2)
      expect(subject.creators.first).to eq('name' => 'Diercks, Ronald L.',
    ...
    it 'book' do
      ...
      expect(subject.creators).to eq([{ 'familyName' => 'Leung', 'givenName' => 'Vincent S.', 'name' => 'Leung, Vincent S.' }])
    ...
    it 'yet another book' do
      ...
      expect(subject.types).to eq('bibtex' => 'book', 'citeproc' => 'book', 'resourceType' => 'Monograph',
                                  'resourceTypeGeneral' => 'Book', 'ris' => 'BOOK', 'schemaOrg' => 'Book')
      expect(subject.creators).to eq([{ 'familyName' => 'McGinnis', 'givenName' => 'Richard Frank', 'name' => 'McGinnis, Richard Frank' }])
    ...
    it 'KISTI' do
      ...
      expect(subject.types).to eq('bibtex' => 'article', 'citeproc' => 'article-journal',
                                  'resourceType' => 'JournalArticle', 'resourceTypeGeneral' => 'JournalArticle', 'ris' => 'JOUR', 'schemaOrg' => 'ScholarlyArticle')
      expect(subject.creators.length).to eq(7)
      expect(subject.creators.first).to eq('familyName' => 'Huang', 'givenName' => 'Guimei', 'name' => 'Huang, Guimei')
    ...
    it 'empty given name' do
      ...
      expect(subject.rights_list).to eq([{ 'rightsUri' => 'http://doi.wiley.com/10.1002/tdm_license_1.1' }])
      expect(subject.dates).to eq([{"date"=>"2010-09-29", "dateType"=>"Issued"}, {"date"=>"2021-07-07", "dateType"=>"Updated"}])
    ...
    it 'report osti' do
      ...
      expect(subject.creators.first).to eq('familyName' => 'Denholm', 'givenName' => 'P.', 'name' => 'Denholm, P.')
