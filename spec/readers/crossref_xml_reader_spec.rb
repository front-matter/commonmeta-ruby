...
describe Briard::Metadata, vcr: true do
  ...
  context 'get crossref metadata' do
    ...
    it 'journal article with RDF for container' do
      ...
      expect(subject.creators.first).to eq("familyName"=>"Escrivà", "givenName"=>"Andreu", "name"=>"Escrivà, Andreu", "nameType"=>"Personal")
    ...
    it 'dissertation' do
      ...
      expect(subject.identifiers.empty?).to be(true)
      expect(subject.descriptions.empty?).to be(true)
      expect(subject.dates).to eq([{"date"=>"2020-06-08", "dateType"=>"Issued"}, {"date"=>"2020-06-08", "dateType"=>"Updated"}])
      expect(subject.publication_year).to eq('2020')
    ...
    it 'book chapter' do
      ...
      expect(subject.types).to eq('bibtex' => 'inbook', 'citeproc' => 'chapter',
                                  'resourceType' => 'BookChapter', 'resourceTypeGeneral' => 'BookChapter', 'ris' => 'CHAP', 'schemaOrg' => 'Chapter')
      expect(subject.creators.length).to eq(2)
      expect(subject.creators.first).to eq('name' => 'Diercks, Ronald L.', 'givenName' => 'Ronald L.', 'familyName' => 'Diercks')
    ...
    it 'affiliation is space' do
      ...
      expect(subject.agency).to eq('Crossref')
      expect(subject.date_registered).to eq('2021-05-16')
    end
