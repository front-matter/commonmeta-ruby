    ...
    module SchemaOrgWriter
      def schema_hsh
        { "@context" => "http://schema.org",
          ...
          "periodical" => type != "Dataset" ? to_schema_org_container(container.to_h, type: "Periodical") : nil,
          "includedInDataCatalog" => type == "Dataset" ? to_schema_org_container(container.to_h, type: "DataCatalog") : nil,
