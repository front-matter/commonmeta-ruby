...
module Briard
  ...
  module Writers
    module DataciteWriter
      def datacite
        types = { "resourceTypeGeneral" => Briard::Utils::CM_TO_DC_TRANSLATIONS.fetch(type, "Other"),
                  "resourceType" => type,
                  "bibtex" => Briard::Utils::CM_TO_BIB_TRANSLATIONS.fetch(type, "misc"),
                  "citeproc" => Briard::Utils::CM_TO_CSL_TRANSLATIONS.fetch(type, "article"),
                  "ris" => Briard::Utils::CM_TO_RIS_TRANSLATIONS.fetch(type, "GEN"),
                  "schemaOrg" => Briard::Utils::CM_TO_SO_TRANSLATIONS.fetch(type, "CreativeWork") }
