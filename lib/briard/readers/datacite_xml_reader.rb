...
module Briard
  module Readers
    module DataciteXmlReader
      def get_datacite_xml(id: nil, **options)
      ...
      def read_datacite_xml(string: nil, **options)
        ...
        if options[:validate]
          errors = nil #datacite_errors(xml: string, schema_version: schema_version)
